...
WebUI.click(findTestObject('Object Repository/New Folder/Page_OrangeHRM/a_Welcome f2222333333'))

WebUI.click(findTestObject('Object Repository/New Folder/Page_OrangeHRM/li_Logout'))
